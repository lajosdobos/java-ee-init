...
//                    = (DepartmentSessionServiceInterface) ctx.lookup
//                    ("java:global/oracle.iqjb.hu_pm-server-ear_ear_1.0-SNAPSHOT/pm-server-ejb-1.0-SNAPSHOT/MyDepartmentSessionService");
        //= (DepartmentSessionServiceInterface) ctx.lookup("oracle.iqjb.hu.pm.intf.message.DepartmentSessionServiceInterface");
        
        
            DepartmentSessionServiceInterface departmentSessionServiceInterface
                    = (DepartmentSessionServiceInterface) ctx.lookup
                    ("java:global.pm-server-ear-1.0-SNAPSHOT.pm-server-ejb-1.0-SNAPSHOT.MyDepartmentSessionService!oracle.iqjb.hu.pm.intf.message.DepartmentSessionServiceInterface");
