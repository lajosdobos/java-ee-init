...
import oracle.iqjb.hu.pm.dm.entities.Address;
import oracle.iqjb.hu.pm.dm.entities.Department;
import oracle.iqjb.hu.pm.dm.entities.Employee;
import oracle.iqjb.hu.pm.dm.entities.Project;
import oracle.iqjb.hu.pm.dm.entities.Role;
import oracle.iqjb.hu.pm.dm.entities.Task;
...
public class Main {
    ...
    private static void loadToDatabase(String pu) {
        ...
        employeee2.setAddress(new Address(222, "city2", "street2"));
