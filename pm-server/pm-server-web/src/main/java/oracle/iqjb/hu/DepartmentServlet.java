...
public class DepartmentServlet extends HttpServlet {
    ...
    @EJB
    private oracle.iqjb.hu.repository.DepartmentRepository1 departmentRepository1;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            departmentRepository1.add(new Department("department"));

            departmentRepository1.findAll().forEach(
                    (Department d) -> out.println("DB1:" + d.getName()));                
